import 'package:detail/product/constraints.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  List colors = [Colors.blue, Colors.green, Colors.yellow, Colors.pink];
  List<String> imagePath = [
    "assets/shoe_blue.png",
    "assets/shoe_green.png",
    "assets/shoe_yellow.png",
    "assets/shoe_pink.png"
  ];
                    ...
                    (index) => GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: selectedColor == colors[index]
                                ? Image.asset("assets/checker.png")
                                : SizedBox(),
